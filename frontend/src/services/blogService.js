...
const blogService = {
    ...
    createPost: async (postData) => {
        const response = await axios.post(`${API_BASE_URL}/api/blog/posts/`, postData, { headers: getHeaders() });
        return response.data;
    },

    updatePost: async (slug, postData) => {
        const response = await axios.put(`${API_BASE_URL}/api/blog/posts/${slug}/`, postData, { headers: getHeaders() });
        return response.data;
    },

    deletePost: async (slug) => {
        await axios.delete(`${API_BASE_URL}/api/blog/posts/${slug}/`, { headers: getHeaders() });
    },

    likePost: async (slug) => {
        const response = await axios.post(`${API_BASE_URL}/api/blog/posts/${slug}/like/`, {}, { headers: getHeaders() });
        return response.data;
    },

    bookmarkPost: async (slug) => {
        const response = await axios.post(`${API_BASE_URL}/api/blog/posts/${slug}/bookmark/`, {}, { headers: getHeaders() });
        return response.data;
    },

    sharePost: async (slug, platform) => {
        const response = await axios.post(`${API_BASE_URL}/api/blog/posts/${slug}/share/`, { platform }, { headers: getHeaders() });
        return response.data;
    },
    ...
    getCategory: async (slug) => {
        const response = await axios.get(`${API_BASE_URL}/api/blog/categories/${slug}/`);
        return response.data;
    },

    getCategoryPosts: async (slug, params = {}) => {
        const response = await axios.get(`${API_BASE_URL}/api/blog/categories/${slug}/posts/`, { params });
        return response.data;
    },
    ...
    getTag: async (slug) => {
        const response = await axios.get(`${API_BASE_URL}/api/blog/tags/${slug}/`);
        return response.data;
    },
    ...
    getComments: async (postId) => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/blog/comments/`, {
                params: { post: postId }
            });
            return response.data;
        } catch (error) {
    ...
    createComment: async (commentData) => {
        try {
            ...
            const response = await axios.post(
                `${API_BASE_URL}/api/blog/comments/`, 
                {
    ...
    deleteComment: async (commentId) => {
        try {
            const headers = getHeaders();
            await axios.delete(`${API_BASE_URL}/api/blog/comments/${commentId}/`, { headers });
        } catch (error) {
    ...
    likeComment: async (commentId, postId) => {
        try {
            const headers = getHeaders();
            const response = await axios.post(
                `${API_BASE_URL}/api/blog/comments/${commentId}/like/`,
                { post: postId },
                { headers }
            );
            return response.data;
    ...
    replyToComment: async (commentId, commentData) => {
        try {
            ...
            const response = await axios.post(
                `${API_BASE_URL}/api/blog/comments/${commentId}/reply/`,
                requestData,
                { headers }
            );
            return response.data;
    ...
    incrementViewCount: async (slug) => {
        const response = await axios.post(`${API_BASE_URL}/api/blog/posts/${slug}/view/`);
        return response.data;
    },
